...
import PlayerOnTaxCellEventPayload from 'model/dto/responses/ws/payload/game/PlayerOnTaxCellEventPayload';
...
export default class PlayerOnTaxCellEventHandler implements EventHandler {
  // eslint-disable-next-line class-methods-use-this
  handleEvent(
    payloadDto: WebSocketPayloadDto<PlayerOnTaxCellEventPayload>
  ): void {
    ...
    spanElement.innerHTML = `Игрок ${nicknameSpanElement.outerHTML} попал на клетку "налог" и должен заплатить 100$`;
